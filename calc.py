...
print("\n")
print(f"Total Package Energy: {sum(pkg_0)*1e-6 + sum(pkg_1)*1e-6} microjoules")
print(f"Total Dram Energy: {sum(dram_0)*1e-6 + sum(dram_1)*1e-6} microjoules")
print("\n")
print(f"Total Package Energy: {sum(pkg_0)*1e-7 + sum(pkg_1)*1e-7} microjoules")
print(f"Total Dram Energy: {sum(dram_0)*1e-7 + sum(dram_1)*1e-7} microjoules")